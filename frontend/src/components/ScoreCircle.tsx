...
export default function ScoreCircle({
  ...
  return (
    <div className="flex h-40 w-40 items-center justify-center rounded-full bg-gradient-to-br from-violet-600 to-fuchsia-600 p-1 shadow-2xl shadow-violet-500/20">
